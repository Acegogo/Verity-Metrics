          ...
          <div>
            ...
            <div className="flex flex-col gap-3 text-sm text-sky-300">
              ...
              <div className="flex gap-3 mt-2">
                <a href="https://web.facebook.com/profile.php?id=61573955033398&locale=en_GB" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-sky-800 hover:bg-sky-700 flex items-center justify-center transition-colors" aria-label="Facebook">
                ...
                <a href="https://x.com/VerityMetrics" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-sky-800 hover:bg-sky-700 flex items-center justify-center transition-colors" aria-label="Twitter">
                ...
                <a href="https://www.linkedin.com/company/verity-metrics-international/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-sky-800 hover:bg-sky-700 flex items-center justify-center transition-colors" aria-label="LinkedIn">
